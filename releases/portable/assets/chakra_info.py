...
app_text = {
    "en": {
        ...
        "app_intro": "Приложение магнитно - резонансной диагностики, газо-разрядной визуализации, 3d моделирования энергоцентров, 2 Аура - камеры 'Кирлиан' и 'Биорезонанс'. Kirlian Platform совместима со всеми типами стандартных приборов магнитно - резонансной диагностики, ГРВ и Кирлиан оборудования, осуществляя обработку данных на качественном современном уровне.",
        ...
        "energy_profiles": "Test Energy Profiles",
        "energy_profile_description": "Select a predefined energy profile to test visualization:",
    ...
    "ru": {
        ...
        "energy_profiles": "Тестовые энергетические профили",
        "energy_profile_description": "Выберите предустановленный энергетический профиль для тестирования визуализации:",
