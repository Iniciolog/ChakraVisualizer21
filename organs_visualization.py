...
class OrgansVisualizer:
    ...
    """
    # Определение позиций и размеров органов (x, y, width, height, rotation_angle)
    organs_positions = {
        "Головной мозг": (0.5, 0.9, 0.15, 0.12, 0),
        "Сердце": (0.5, 0.55, 0.12, 0.1, 0),
        "Легкие": [(0.4, 0.55, 0.08, 0.15, 0), (0.6, 0.55, 0.08, 0.15, 0)],
        "Печень": (0.45, 0.4, 0.14, 0.08, 0),
        "Желудок": (0.55, 0.42, 0.1, 0.06, 0),
        "Поджелудочная железа": (0.52, 0.35, 0.08, 0.04, 0),
        "Кишечник": (0.5, 0.3, 0.2, 0.1, 0),
        "Почки": [(0.4, 0.35, 0.06, 0.08, 0), (0.6, 0.35, 0.06, 0.08, 0)],
        "Мочевой пузырь": (0.5, 0.2, 0.08, 0.06, 0),
        "Щитовидная железа": (0.5, 0.65, 0.08, 0.02, 0),
        "Селезенка": (0.6, 0.38, 0.06, 0.05, 0),
        "Надпочечники": [(0.42, 0.31, 0.04, 0.04, 0), (0.58, 0.31, 0.04, 0.04, 0)]
    }
    ...
    def _draw_human_silhouette(self, ax):
        """
        Рисует силуэт человеческого тела.
    ...
    def create_organs_visualization(self, diagnostic_data: Dict[str, Dict[str, Any]]):
        ...
        ax.text(0.5, 0.03, self.translations[self.lang]['hover_text'], 
